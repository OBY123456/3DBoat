    ...
    public class WeatherMakerConfigurationScript : MonoBehaviour
    {
        ...
        private void UpdateTimeOfDay()
        {
            if (WeatherMakerDayNightCycleManagerScript.Instance != null)
            {
                ...
                {
                    if (DawnDuskSlider.value > 22400 && DawnDuskSlider.value < 71172)
                    {
                        RenderSettings.fogColor = new Color(212 / 255f, 237 / 255f, 238 / 255f);
                    }
                    else if ((DawnDuskSlider.value >= 71172 && DawnDuskSlider.value < 80000) || (DawnDuskSlider.value > 8000 && DawnDuskSlider.value <= 22400))
                    {
                        RenderSettings.fogColor = new Color(59 / 255f, 72 / 255f, 73 / 255f);
                    }
                    else if (DawnDuskSlider.value <= 8000 || DawnDuskSlider.value >= 80000)
                    {
        ...
        public void ChangeFogValue()
        {
            RenderSettings.fogDensity = FogSlider.value; 
        }
        ...
        private void Start()
        {
            ...
            {
                WeatherMakerPrecipitationManagerScript.Instance.PrecipitationIntensity = IntensitySlider.value = 0.25f;
            }
